    ...
    case 'adj':{
      ...
      mkBatch(c,'adj',ds,
        ...
        (i,batch)=>{
          ...
          // Fix: pick the same conjugation form from OTHER adjectives as distractors
          const allAdj=[...I_ADJ,...NA_ADJ];
          const others=shuf(allAdj.filter(a=>a!==i&&a[_aqf.i]&&a[_aqf.i]!==correct).map(a=>a[_aqf.i])).slice(0,3);
          const o=shuf([correct,...others]);
